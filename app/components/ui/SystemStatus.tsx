    ...
    return (
        <aside className="system-status-panel w-full lg:w-80 flex-shrink-0 flex flex-col gap-4 lg:sticky lg:top-8 lg:h-[calc(100vh-4rem)] z-50">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="text-sm font-bold text-zinc-100 tracking-tighter uppercase leading-none mb-0.5">
                            {displayText}<span className="animate-pulse text-[var(--terminal-green)]">_</span>
                        </div>
            ...
            <div className={`${isOpen ? 'flex' : 'hidden'} lg:flex flex-col gap-4 w-full h-full transition-all duration-300`}>
                ...
                {/* Profile Card */}
                <div className="hidden lg:block border border-zinc-800 bg-zinc-950 p-5 relative overflow-hidden group glass-panel glow-hover">
                    ...
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="text-right">
                            <div ref={nameRef} className="text-xl font-bold text-zinc-100 tracking-tighter uppercase leading-none mb-1 typewriter-cursor">
                                {displayText}
                            </div>
